...
def plot(animals, plantObjects, clusterObjects, preyPlotHandle, plantPlotHandle, clusterPlotHandle):
...
def main():
    ...
    for prey in preys:
        prey.update_pointers(preys, plantObjects, clusterObjects)
    ...
    while True:
        ...
        if i%100 == 0:
            print("i = %i\n# of preys = %i\n" %(i,np.size(preys)))
        plot(preys, plantObjects, clusterObjects, preyPlotHandle, plantPlotHandle, clusterPlotHandle)
