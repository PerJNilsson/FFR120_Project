...
class Predator(Animal):
    maxHunger = 600  # The maximum amount of food the predator can store.

    # Example of using a parent's constructor
    def __init__(self, nLatticeLength, x=None, y=None, visibilityRadius=15, reproductionRate=0.015,child=False, randomTurnProbability=0.1):
        ...
        if child:
            ...
            self.hunger = 600  # The initial preys start out with almost full hunger bar.
    ...
    def searchPrey(self):
        ...
        if self.hunger < 550: # If recently eaten will not move
